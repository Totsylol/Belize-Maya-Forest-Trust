                ...
                <div className={styles.introContent}>
                    ...
                    <div className={styles.mapSide}>
                        <img
                            ...
                            onClick={() => handleImageClick(MapSC, "Map of Stakeholder Communities")}
                        />
                        <p className={styles.mapCaption}>Stakeholder Communities Map</p>
                    </div>
                </div>
            </section>
