      ...
      <header className={styles.header}>
        <img src={Topstaff} alt="Header" />
            ...
            <section className={`${styles.outreachSection} ${styles.rangers}`}>
                ...
                <div className={styles.imageSide}>
                    <img src={Supp} alt="Rangers" className={styles.image} />
                </div>
            </section>
            <section className={`${styles.outreachSection} ${styles.boardMembers}`}>
                <div className={styles.imageSide}>
                    <img src={Vol} alt="Board Members" className={styles.image} />
                </div>
                <div className={styles.textSide}>
                    <h2>Volunteers and Interns</h2>
                    <p>
                    Volunteers and interns are crucial to the Belize Maya Forest Trust (BMFT). Their dedication and hard work are essential in advancing our conservation efforts and expanding our impact.                    </p>
                    <button className={styles.outreachButton}>See More </button>
                </div>
            </section>
      </div>
